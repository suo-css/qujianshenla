...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('User/personal_add',array('table'=>ACTION_NAME));?>">新 增</a>
 ...
 <button class="btn ajax-post" url="<?php echo U('User/status_info',array('status'=>'0','table'=>ACTION_NAME));?>" target-form="ids">禁 用</button> -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["homeadd"]); ?> </td>
			<td><?php echo ($vo["gymadd"]); ?> </td>
			<td><?php echo ($vo["occupation"]); ?> </td>
			<td>
<!-- 				<?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('User/status_info',array('status'=>'1','table'=>ACTION_NAME,id=>$vo['id']));?>" class="ajax-get">禁用</a>
<?php else: ?>
<a href="<?php echo U('User/status_info',array('status'=>'0','table'=>ACTION_NAME,id=>$vo['id']));?>" class="ajax-get">启用</a><?php endif; ?> -->
				<a href="<?php echo U('User/delete_info',array('table'=>ACTION_NAME,'id'=>$vo['id']));?>" class="confirm ajax-get">删除</a>
				<a href="<?php echo U('User/update_personal',array('id'=>$vo['id']));?>" >修改</a>
