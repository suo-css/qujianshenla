...
<body>
	...
	<div class="cf">
		<div class="fl">
            <button class="btn ajax-post confirm" url="<?php echo U('memberexctpl/delete',array('table'=>memberexctpl));?>" target-form="ids">删 除</button>
        </div>
    ...
    <tbody>
		<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["tpljson"]); ?></td>
			<td><?php echo ($vo["starttime"]); ?></td>
			<td><?php echo ($vo["endtime"]); ?></td>
			<td><?php echo ($vo["status"]); ?></td>
			<td><?php echo ($vo["currentflag"]); ?></td>
			<td>
				<a href="<?php echo U('Memberexctpl/delete',array('table'=>Memberexctpl,'id'=>$vo['id']));?>" class="confirm ajax-get">删除</a>
			</td>
                </td>
