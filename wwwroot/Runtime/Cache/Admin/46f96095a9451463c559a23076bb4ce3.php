...
<body>
	...
	<script type="text/javascript" src="/git/qujianshen/wwwroot/Public/static/uploadify/jquery.uploadify.min.js"></script>
							...
							<?php case "picture_union": ?><div class="controls">
								...
								<script type="text/javascript">
									...
									$("#upload_picture_<?php echo ($o_key); ?>").uploadify({
										"height"          : 30,
										"swf"             : "/git/qujianshen/wwwroot/Public/static/uploadify/uploadify.swf",
									...
									function uploadPicture<?php echo ($o_key); ?>(file, data){
										...
										var src = '';
										if(data.status){
											src = data.url || '/git/qujianshen/wwwroot' + data.path
											$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
												'<div class="upload-pre-item" val="' + data.id + '"><img src="/git/qujianshen/wwwroot' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
											);
														...
														function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
															...
															if(data.status){
																...
																$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
																	'<div class="upload-pre-item" val="' + data.id + '"><img src="/git/qujianshen/wwwroot' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
																);
