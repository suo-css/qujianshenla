...
<body>
    ...
    <form action="<?php echo U('goal/save');?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="name" value=<?php echo ($list["name"]); ?>>
            </div>
        </div> 
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="unit" value=<?php echo ($list["unit"]); ?>>
            </div>
        </div>
        <input type="hidden" value="goalcontinuetype" name="table">
        <div class="form-item">
