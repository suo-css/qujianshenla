...
<body>
    ...
    <form action="<?php echo U('goal/save');?>" method="post" class="form-horizontal">

        <div class="form-item">
            <label class="item-label">ID<span class="check-tips">（ID不能为空）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="id" value="<?php echo ($list["id"]); ?>">
            </div>
        </div> 
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="typename" value="<?php echo ($list["typename"]); ?>">
            </div>
        </div> 
        <div class="form-item">
            <label class="item-label">moduleid<span class="check-tips">（moduleid不能为空）</span></label>
              <select name="moduleid">
                    <?php if(is_array($le)): $i = 0; $__LIST__ = $le;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['moduleid']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
        <input type="hidden" value="goaltype" name="table">
        <div class="form-item">
