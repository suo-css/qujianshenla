...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('User/sectioninfo_add',array('table'=>ACTION_NAME));?>">新 增</a>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('User/status_info',array('status'=>'1','table'=>ACTION_NAME,id=>$vo['id']));?>" class="ajax-get">禁用</a>
				<?php else: ?>
				...
				<a href="<?php echo U('User/update_sectioninfo',array('id'=>$vo['id']));?>" >修改</a>
